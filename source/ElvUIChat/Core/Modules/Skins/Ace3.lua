...
function S:Ace3_RegisterAsWidget(widget)
	...
	if TYPE == 'MultiLineEditBox' or TYPE == 'MultiLineEditBox-ElvUIChat' then
	...
	elseif TYPE == 'CheckBox' then
		...
		checkbg:CreateBackdrop(nil, nil, nil, nil, nil, true)
	...
	elseif TYPE == 'LSM30_Font' or TYPE == 'LSM30_Sound' or TYPE == 'LSM30_Border' or TYPE == 'LSM30_Background' or TYPE == 'LSM30_Statusbar' then
		...
		frame:StripTextures()
		frame:CreateBackdrop(nil, nil, nil, nil, nil, true)
	...
	elseif TYPE == 'Button' or TYPE == 'Button-ElvUIChat' then
		local frame = widget.frame
		S:HandleButton(frame, true)
	elseif TYPE == 'Slider' or TYPE == 'Slider-ElvUIChat' then
	...
	elseif TYPE == 'ColorPicker' or TYPE == 'ColorPicker-ElvUIChat' then
		local frame = widget.frame
...
do -- Early Skin Loading
	local Libraries = {
		...
		['AceConfigDialog-3.0-ElvUIChat'] = true,
	...
	function S:LibStub_NewLib(major)
		...
		if Libraries[n] then
			...
			elseif n == 'AceConfigDialog' or n == 'AceConfigDialog-3.0-ElvUIChat' then
				if early then
					tinsert(S.EarlyAceTooltips, major)
				else
