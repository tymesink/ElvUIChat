...
local MediaPath = {
	font	= [[Interface\AddOns\ElvUIChat\Core\Media\Fonts\]],
	sound	= [[Interface\AddOns\ElvUIChat\Core\Media\Sounds\]],
	arrow	= [[Interface\AddOns\ElvUIChat\Core\Media\Arrows\]],
	mail	= [[Interface\AddOns\ElvUIChat\Core\Media\MailIcons\]],
	resting = [[Interface\AddOns\ElvUIChat\Core\Media\RestIcons\]],
	emoji	= [[Interface\AddOns\ElvUIChat\Core\Media\ChatEmojis\]],
	logo	= [[Interface\AddOns\ElvUIChat\Core\Media\ChatLogos\]],
	texture	= [[Interface\AddOns\ElvUIChat\Core\Media\Textures\]]
}
...
AddMedia('texture','GlowTex',		'ElvUIChat GlowBorder', 'border')
AddMedia('texture','NormTex',		'ElvUIChat Gloss',	'statusbar')
AddMedia('texture','NormTex2',		'ElvUIChat Norm',	'statusbar')
AddMedia('texture','NormTex3',		'ElvUIChat Norm1',	'statusbar')
AddMedia('texture','White8x8',		'ElvUIChat Blank', {'statusbar','background'})
...
do -- LSM Font Preloader ~Simpy
	...
	-- this helps fix most of the issues with fonts or textures reverting to default because the addon providing them is loading after ElvUIChat
