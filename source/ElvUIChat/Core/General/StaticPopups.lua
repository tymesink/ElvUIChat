...
E.PopupDialogs.CLIENT_UPDATE_REQUEST = {
	text = L["Detected that your ElvUIChat Options addon is out of date. This may be a result of your Tukui Client being out of date. Please visit our download page and update your Tukui Client, then reinstall ElvUIChat. Not having your ElvUIChat Options addon up to date will result in missing options."],
	button1 = OKAY,
	OnAccept = E.noop,
	showAlert = 1,
}
...
E.PopupDialogs.APPLY_FONT_WARNING = {
	text = L["Are you sure you want to apply this font to all ElvUIChat elements?"],
