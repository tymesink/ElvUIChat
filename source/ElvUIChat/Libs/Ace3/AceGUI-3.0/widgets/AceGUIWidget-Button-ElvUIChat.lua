...
Graphical Button.
-------------------------------------------------------------------------------]]
local Type, Version = "Button-ElvUIChat", 4
...
local DragTooltip = CreateFrame("GameTooltip", "ElvUIChatAceGUIWidgetDragTooltip", UIParent, "GameTooltipTemplate")
-- GLOBALS: ElvUIChat
...
local function lockTooltip()
	_G.ElvUIChatAceConfigDialogTooltip:Hide()
...
Constructor
-------------------------------------------------------------------------------]]
local S -- ref for Skins module in ElvUIChat
local function Constructor()
	...
	if not dragdropButton then
		dragdropButton = CreateFrame("Button", "ElvUIChatAceGUI30DragDropButton", UIParent, "UIPanelButtonTemplate")
		...
		if not S and ElvUIChat[1].private.skins.ace3Enable then
			S = ElvUIChat[1]:GetModule('Skins')
