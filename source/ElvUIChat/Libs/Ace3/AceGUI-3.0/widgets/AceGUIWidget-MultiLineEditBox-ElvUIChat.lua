...
-------------------------------------------------------------------------------]]
local Type, Version = "MultiLineEditBox-ElvUIChat", 31
...
local function OnClick(self)                                                     -- Button
	...
	if not self:Fire("OnEnterPressed", self.editBox:GetText(true)) then -- ElvUIChat changed
		self.button:Disable()
	end
end
...
local methods = {
	...
	-- ElvUIChat block, this it to support plugins that use FAIAP
